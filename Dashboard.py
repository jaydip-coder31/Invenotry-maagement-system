...
class IMS:
    def __init__(self,root):
        ...
        #------------- title --------------
        self.icon_title=PhotoImage(file="images/Pic2.png")
        ...
        #------------ footer -----------------
        lbl_footer=Label(self.root,text="IMS-Inventory Management System | Developed by Jaydip Solanki\nFor any Technical Issues Contact: 7096358911",font=("times new roman",12),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
